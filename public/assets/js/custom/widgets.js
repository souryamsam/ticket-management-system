...
var KTWidgets = function () {
    ...
    var initMixedWidget6 = function() {
        ...
        [].slice.call(charts).map(function(element) {
            ...
            var options = {
                series: [{
                    name: "Today's Dockets",
                    data: [20, 15, 25, 18, 30, 22, 27] // Replace with your data for the last 7 days
                }],
                chart: {
                    fontFamily: 'inherit',
                    type: 'area',
                ...
                tooltip: {
                    ...
                    y: {
                        formatter: function (val) {
                            return val; // Only return the value
                        }
                    }
                },
                colors: [lightColor],
    ...
    var initMixedWidget10 = function() {
        ...
        [].slice.call(charts).map(function(element) {
            ...
            options = {
                ...
                colors: ['#753CEC', '#F1416C'], // Purple and Pink
                grid: {
                    padding: {
                        top: 10
                    },
    ...
    var initMixedWidget12 = function() {
        ...
        var height;
        var labelColor = KTUtil.getCssVariableValue('--bs-gray-500');
        var borderColor = KTUtil.getCssVariableValue('--bs-pink-200');
        var options;
        var chart;
